...
public class Controller extends Thread{
	...
	public static String[] ObjectState = new String[8];
...
/*	public static synchronized void setNodeState(String state)
	...
	public static synchronized void setObjectState(int ObjectNumber,String State)
	{
		...
		System.out.println("Setting the state of the Object " + ObjectNumber + " to " + State);
//		System.out.println("The Object State array is " + ObjectState);
	}
}
